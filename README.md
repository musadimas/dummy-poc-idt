...
**Google Drive** — set konstanta berikut di `seed_data.py`:
...
6. Set konstanta di `seed_data.py`:
   ```python
...
| _(selasa–minggu)_   |       | Kolom jam serupa untuk hari lainnya                                                     |
...
| _(selasa–minggu)_                 |       | Kolom jam serupa                                                                   |
